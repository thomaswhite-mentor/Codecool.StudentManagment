...
namespace Codecool.StudentManagment.Api.Utils
{
    public static class HandlerRegistration
    {
        ...
        private static Type ToDecorator(object attribute)
        {
            ...
            if (type == typeof(LogAttribute))
                return typeof(LoggingDecorator<>);
        ...
        private static bool IsHandlerInterface(Type type)
        {
            ...
            return typeDefinition == typeof(ICommandHandler<>) || typeDefinition == typeof(IQueryHandler<,>) || typeDefinition == typeof(IDomainEventHandler<>);
        }
    }
}
